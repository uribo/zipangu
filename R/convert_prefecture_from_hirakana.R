...
#' List of prefecture long names in hirakana
#'
prefecture_hira_long <- c("\u307b\u3063\u304b\u3044\u3069\u3046","\u3042\u304a\u3082\u308a\u3051\u3093","\u3044\u308f\u3066\u3051\u3093",
                          "\u307f\u3084\u304e\u3051\u3093","\u3042\u304d\u305f\u3051\u3093","\u3084\u307e\u304c\u305f\u3051\u3093",
                          "\u3075\u304f\u3057\u307e\u3051\u3093","\u3044\u3070\u3089\u304d\u3051\u3093","\u3068\u3061\u304e\u3051\u3093",
                          "\u3050\u3093\u307e\u3051\u3093","\u3055\u3044\u305f\u307e\u3051\u3093","\u3061\u3070\u3051\u3093",
...
#' List of prefecture short names in hirakana
#'
prefecture_hira_short <- c("\u307b\u3063\u304b\u3044\u3069\u3046","\u3042\u304a\u3082\u308a","\u3044\u308f\u3066",
                           "\u307f\u3084\u304e","\u3042\u304d\u305f","\u3084\u307e\u304c\u305f",
                           "\u3075\u304f\u3057\u307e","\u3044\u3070\u3089\u304d","\u3068\u3061\u304e",
                           "\u3050\u3093\u307e","\u3055\u3044\u305f\u307e","\u3061\u3070",
                           "\u3068\u3046\u304d\u3087\u3046","\u304b\u306a\u304c\u308f","\u306b\u3044\u304c\u305f",
...
convert_prefecture_from_hirakana <- function(x){
  ...
  for(i in 1:length(x)){
    if(any(str_detect(prefecture_hira_long, x[i]))){
      x[i] <- prefecture_kanji_long[str_detect(prefecture_hira_long, x[i])]
    } else if(any(str_detect(prefecture_hira_short, x[i]))){
      x[i] <- prefecture_kanji_short[str_detect(prefecture_hira_short, x[i])]
    } else {
      stop("\u5b58\u5728\u3057\u306a\u3044\u5730\u57df\u304c\u542b\u307e\u308c\u3066\u3044\u307e\u3059")
    }
  }
